...
- [x] 6.1 建立隱私權政策頁面，列出蒐集項目、用途、保留期限、取消訂閱之聯絡方式；驗證：人工檢視頁面內容涵蓋上述四項
- [x] 6.2 撰寫徵詢來源維運單位（foodsafety@email.ncku.edu.tw）同意的信件草稿，對應 proposal Impact 所述正式公開前置條件；驗證：信件涵蓋服務性質、預期查詢頻率、聯絡方式三項內容，經人工確認後才寄出
